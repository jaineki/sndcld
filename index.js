...
try {
    ...
    console.error("Make sure your FIREBASE_PRIVATE_KEY is correctly formatted in Render env vars.");
    console.error("Tip: Paste the entire private key (including -----BEGIN PRIVATE KEY-----) with actual newlines (not \\n).");
    process.exit(1);
}
...
// playlistSongs/{playlistId}/{position} -> { songId, title, artist, artwork, streamUrl, addedAt, position }
